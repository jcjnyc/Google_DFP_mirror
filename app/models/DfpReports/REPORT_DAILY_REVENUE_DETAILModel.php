...
class REPORT_DAILY_REVENUE_DETAILModel extends GoogleDfpReportModel {

  public $fileLabel        = 'REPORT_DAILY_REVENUE_DETAIL';
...
## ADSENSE_LINE_ITEM_LEVEL_REVENUE
  ...
  public $model = array('table' => 'REPORT_DAILY_REVENUE_DETAIL',
			...
			'keys' => array('primary key' => array('report_date','AD_UNIT_ID','ADVERTISER_ID','ORDER_ID','LINE_ITEM_ID','COUNTRY_CRITERIA_ID'),
